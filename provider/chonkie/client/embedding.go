...
const (
	...
	EmbeddingModelChonkieEmbeddingsV4 EmbeddingModel = "chonkie-embeddings-v4"

	// Multilingual multimodal text & image embeddings
	EmbeddingModelChonkieClipV2 EmbeddingModel = "chonkie-clip-v2"

	// Frontier multilingual embeddings (SOTA text-only)
	EmbeddingModelChonkieEmbeddingsV3 EmbeddingModel = "chonkie-embeddings-v3"

	// Multimodal embeddings for images and English text (deprecated)
	EmbeddingModelChonkieClipV1 EmbeddingModel = "chonkie-clip-v1"

	// Spanish-English bilingual embeddings
	EmbeddingModelChonkieEmbeddingsV2BaseEs EmbeddingModel = "chonkie-embeddings-v2-base-es"

	// Code/docstring-optimized embeddings
	EmbeddingModelChonkieEmbeddingsV2BaseCode EmbeddingModel = "chonkie-embeddings-v2-base-code"

	// German-English bilingual embeddings
	EmbeddingModelChonkieEmbeddingsV2BaseDe EmbeddingModel = "chonkie-embeddings-v2-base-de"

	// Chinese-English bilingual embeddings
	EmbeddingModelChonkieEmbeddingsV2BaseZh EmbeddingModel = "chonkie-embeddings-v2-base-zh"

	// English-only embeddings (deprecated)
	EmbeddingModelChonkieEmbeddingsV2BaseEn EmbeddingModel = "chonkie-embeddings-v2-base-en"
)
